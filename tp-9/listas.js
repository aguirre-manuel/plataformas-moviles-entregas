...
function sumarLista(listaDeNumeros) {
    return listaDeNumeros.reduce((suma,numero)=>suma+numero)
}
console.log("sumarLista([2,3,4]): ", sumarLista([2,3,4]))
console.log("sumarLista2([4,6,11]): ", sumarLista([4,6,11]))
...
function calcularPromedio(listaDeNumeros) {
    return listaDeNumeros.reduce((suma, numero) => suma + numero) / listaDeNumeros.length;
}
...
console.log("ordenarDeMayorAMenor([2,3,1,4]): ", ordenarDeMayorAMenor([1,2,3,4]))
...
function encontrarPalabraMasCorta(listaDePalabras) {
    return listaDePalabras.reduce((corta, palabras) => palabras.length < corta.length ? palabras : corta, listaDePalabras[0]);
}
